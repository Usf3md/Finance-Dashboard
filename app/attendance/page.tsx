...
const Page = ({ searchParams }: Props) => {
  ...
  const [start, setStart] = useState(searchParams.min_date);
  const [end, setEnd] = useState(searchParams.max_date);
  ...
  useEffect(() => {
    setIsLoading(true);
    fetch(
      `/api/attendance/member/?min_date=${searchParams.min_date}&max_date=${searchParams.max_date}`
    )
      .then((res) => {
  ...
  }, [searchParams.min_date, searchParams.max_date]);
  return (
      ...
      <div className="flex gap-4 justify-between">
        ...
        <div className="flex flex-col lg:flex-row gap-4 w-1/2 lg:items-end">
          <Input
            ...
            radius="sm"
            defaultValue={searchParams.min_date}
            value={start}
          ...
          <Input
            ...
            placeholder="Select Date"
            radius="sm"
            defaultValue={searchParams.max_date}
            value={end}
